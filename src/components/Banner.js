            ...
            <div className="container mx-auto xl:px-32">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="mt-12 lg:mt-0">
                        <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">The best offer for your  <br /><span className="text-blue-600">Next Photography Session!!</span></h1>
                    ...
                    <div className="mb-12 lg:mb-0">
                        <img
                            src="https://www.thoughtco.com/thmb/uHaqS2Nr_Z-DGRxVbWgId1tH66c=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/film-photography-592347645-59e4d0609abed500119e7b14.jpg"
